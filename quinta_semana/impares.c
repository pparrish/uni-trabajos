...
void main(){
   int num1, num2, err = 0;
	...
	printf("Ingresa dos numeros separados por un espacio para imprimir un intervalo en numeros impares\n");
   scanf("%d %d", &num1, &num2);

   if(num1 > num2){
   	printf("Los datos no son validos, el segundo numero tiene que ser mayor\n");
      err = 1;
   }
  	if(!err){
